      ...
      <div className="resume--grid">
        ...
        <div className="resume--grid--detail">
          <div className="resume--grid--detail--data">
            {/* MOVED: índice "05 // Resume" aquí para que esté junto al nombre/título */}
            <motion.h3
              initial="hidden"
              animate={controls}
              variants={opacityVariant}
              transition={{ duration: 1, delay: 0.4 }}
              className="theme--text resume--index"
            >
        ...
        <div className="resume--grid--experience">
          <div className="resume--grid--experience--head">
            {/* removed duplicated h3 here (moved to detail) */}
            {/* <p className="theme--detail resume--intro"> ... </p> */}
          </div>
